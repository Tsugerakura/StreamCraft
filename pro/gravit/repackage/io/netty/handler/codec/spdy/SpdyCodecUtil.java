...
/* 245 */     return (buf.getByte(offset) & 0xFF) << 8 | buf
/* 246 */       .getByte(offset + 1) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 253 */     return (buf.getByte(offset) & 0xFF) << 16 | (buf
/* 254 */       .getByte(offset + 1) & 0xFF) << 8 | buf
/* 255 */       .getByte(offset + 2) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 262 */     return (buf.getByte(offset) & Byte.MAX_VALUE) << 24 | (buf
/* 263 */       .getByte(offset + 1) & 0xFF) << 16 | (buf
/* 264 */       .getByte(offset + 2) & 0xFF) << 8 | buf
/* 265 */       .getByte(offset + 3) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 272 */     return (buf.getByte(offset) & 0xFF) << 24 | (buf
/* 273 */       .getByte(offset + 1) & 0xFF) << 16 | (buf
/* 274 */       .getByte(offset + 2) & 0xFF) << 8 | buf
/* 275 */       .getByte(offset + 3) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 290 */     ObjectUtil.checkNotNull(name, "name");
/* 291 */     if (name.length() == 0) {
/* 292 */       throw new IllegalArgumentException("name cannot be length zero");
/*     */     }
/*     */ 
/*     */ 
/*     */     
/* 297 */     if (name.length() > 65535) {
/* 298 */       throw new IllegalArgumentException("name exceeds allowable length: " + name);
/*     */     }
/*     */     
/* 301 */     for (int i = 0; i < name.length(); i++) {
/* 302 */       char c = name.charAt(i);
/* 303 */       if (c == '\000') {
/* 304 */         throw new IllegalArgumentException("name contains null character: " + name);
/*     */       }
/*     */       
/* 307 */       if (c >= 'A' && c <= 'Z') {
/* 308 */         throw new IllegalArgumentException("name must be all lower case.");
/*     */       }
/* 310 */       if (c > '') {
/* 311 */         throw new IllegalArgumentException("name contains non-ascii character: " + name);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 321 */     ObjectUtil.checkNotNull(value, "value");
